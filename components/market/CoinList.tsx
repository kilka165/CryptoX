      ...
      <table className="w-full">
        <thead>
          <tr className="text-xs text-slate-500 border-b border-slate-100 dark:border-slate-800">
            ...
            <th className="pb-3 text-right w-16" />
          </tr>
        </thead>
            ...
            >
              ...
              <td className="py-4 pr-2">
                <div className="flex items-center gap-3">
                  <CoinImage coinId={coin.id} name={coin.name} className="w-8 h-8 rounded-full shrink-0" />
              ...
              <td
                className={`py-4 text-right text-sm font-medium whitespace-nowrap px-2 ${
