    ...
    <footer className="bg-slate-950 text-slate-300 border-t border-slate-800 mt-12">
      <div className="max-w-7xl mx-auto px-4 py-10 md:py-12">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-10">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-3 text-slate-400">
              <button className="p-2 rounded-full bg-slate-900 hover:bg-slate-800">
                <Twitter size={16} />
              </button>
              <button className="p-2 rounded-full bg-slate-900 hover:bg-slate-800">
                <Facebook size={16} />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 text-sm">
          <div>
            <h4 className="text-slate-100 font-semibold mb-4">О нас</h4>
          ...
          <div>
            <h4 className="text-slate-100 font-semibold mb-4">Продукты</h4>
            <nav className="space-y-2 text-slate-400">
          ...
          <div>
            <h4 className="text-slate-100 font-semibold mb-4">Для компаний</h4>
            <nav className="space-y-2 text-slate-400">
          ...
          <div>
            <h4 className="text-slate-100 font-semibold mb-4">Узнать больше</h4>
            <nav className="space-y-2 text-slate-400">
        ...
        {/* низ */}
        <div className="mt-10 border-t border-slate-800 pt-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-3 text-xs text-slate-500">
...
const FooterLink = ({
  ...
  <Link
    href={href}
    className="block hover:text-slate-100 hover:underline underline-offset-4"
  >
    {children}
  </Link>
);
